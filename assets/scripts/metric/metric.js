angular.module('metricModule', ['coreApp'])
    ...
    .factory('metricRest', function ($log, coreApp, $resource) {
        ...
        return $resource(restMetricUrl + 'data/', {}, {
                getStacktrace: {url: restMetricUrl + 'stacktrace', params: {}},
                //list
                query: {url: restMetricUrl + ':query', params: {}, isArray: true},
                //actions
                restart: {url: restMetricUrl + 'restart', params: {}},
                //dictionaries
                // dictionaryOptions: {url: restMetricUrl + '/options/', params: {}, isArray: true, cache: true}
    ...
    .controller('metricListController', function ($log, $scope, metricRest, coreApp, $state,$stateParams) {
